...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Rwa Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Rwa Core"

/* Copyright year */
#define COPYRIGHT_YEAR 2030
...
#define PACKAGE_BUGREPORT "https://github.com/rwa/rwa/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rwa Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rwa Core 0.25.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rwa"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://rwacore.org/"
