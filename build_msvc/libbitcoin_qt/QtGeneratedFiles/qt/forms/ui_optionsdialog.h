...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Bitcoin network through a separate SOCKS5 proxy for Tor onion services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
